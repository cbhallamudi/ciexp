...
class AdminController extends CI_Controller
{
	...
	public function adminheaderpagesettings(){
		if($this->session->userdata('usersid')==""){
			$this->session->set_flashdata('failure','Please Login');
			redirect('admin');
		}
		...
		$data['notifications'] = $this->Main_model->getAllData('notifications');
		$this->load->view('includes/adminheader',$data);
		$this->load->view('admin/headerpagesettings');
		$this->load->view('includes/adminfooter');
	}
	public function adminfooterpagesettings(){
		if($this->session->userdata('usersid')==""){
			$this->session->set_flashdata('failure','Please Login');
			redirect('admin');
		}
		...
		$data['notifications'] = $this->Main_model->getAllData('notifications');
		$this->load->view('includes/adminheader',$data);
		$this->load->view('admin/footerpagesettings');
		$this->load->view('includes/adminfooter');
	}
	...
	{
		$notification = $this->Main_model->getAllDataWhere('notifications',array('notificationid'=>$notId));
