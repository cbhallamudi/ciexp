...
*/
$route['default_controller'] = 'welcome';
$route['front-page/(:any)'] = 'welcome/frontPage/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['create-new-table'] = 'welcome/createNewTable';
...
$route['admin-headerpagesettings'] = 'adminController/adminheaderpagesettings';
$route['admin-footerpagesettings'] = 'adminController/adminfooterpagesettings';
